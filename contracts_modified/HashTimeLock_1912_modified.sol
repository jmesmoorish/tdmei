...
contract HashTimeLock_Factory { //contract factory pattern
    address[] public deployedHashTimeLocks;

    function createRigidBit() public {
        address newHashTimeLock = address (new HashTimeLock ());
        deployedHashTimeLocks.push(newHashTimeLock);
    }

    function getDeployedHashTimeLock() public view returns (address[] memory) {
        return deployedHashTimeLocks;
    }
}
