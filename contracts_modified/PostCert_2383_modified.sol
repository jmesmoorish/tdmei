...
contract PostCert_Factory { //contract factory pattern
    address[] public deployedPostCerts;

    function createPostCert() public {
        address newPostCert = address (new PostCert ());
        deployedPostCerts.push(newPostCert);
    }

    function getDeployedPostCert() public view returns (address[] memory) {
        return deployedPostCerts;
    }
}
