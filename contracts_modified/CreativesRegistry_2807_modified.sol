...
contract CreativesStorage_Factory is Ownable { //contract factory pattern
    address[] public deployedCreativesStorages;

    function createCreativesStorage() public {
        address newCreativesStorage = address (new CreativesStorage ());
        deployedCreativesStorages.push(newCreativesStorage);
    }

    function getDeployedCreativesStorage() public view returns (address[] memory) {
        return deployedCreativesStorages;
    }
}
