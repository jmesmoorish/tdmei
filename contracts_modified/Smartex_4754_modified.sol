...
contract Smartex_Factory { //contract factory pattern
    address[] public deployedSmartexs;

    function createSmartex() public {
        address newSmartex = address (new Smartex ());
        deployedSmartexs.push(newSmartex);
    }

    function getDeployedSmartex() public view returns (address[] memory) {
        return deployedSmartexs;
    }
}
