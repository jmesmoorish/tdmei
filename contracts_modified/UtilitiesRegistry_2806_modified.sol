...
contract UtilitiesStorage_Factory is Ownable { //contract factory pattern
    address[] public deployedUtilitiesStorages;

    function createCreativesStorage() public {
        address newUtilitiesStorage = address (new UtilitiesStorage ());
        deployedUtilitiesStorages.push(newUtilitiesStorage);
    }

    function getDeployedUtilitiesStorage() public view returns (address[] memory) {
        return deployedUtilitiesStorages;
    }
