...
contract Jug_Factory { //contract factory pattern
    address[] public deployedJugs;

    function createJug() public {
        address newJug = address (new Jug (msg.sender));
        deployedJugs.push(newJug);
    }

    function getDeployedJug() public view returns (address[] memory) {
        return deployedJugs;
    }
}
