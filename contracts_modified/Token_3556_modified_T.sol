...
library SafeMath { // safemath pattern 
...
contract ERC20Interface { // token pattern
  function transfer(address toAddr, uint256 amountInWei) public returns (bool success);
  function transferFrom(address fromAddr, address toAddr, uint256 amountInWei) public returns (bool success);
  function approve(address spender, uint256 amountInWei) public returns (bool success);
