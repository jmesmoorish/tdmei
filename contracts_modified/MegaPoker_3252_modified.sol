...
contract MegaPoker_Factory { //contract factory pattern
    address[]  public deployedMegaPokers;

    function createMegaPoker() public {
        address newMegaPoker = address(new MegaPoker ());
        deployedMegaPokers.push(newMegaPoker);
    }

    function getDeployedMegaPoker() public view returns (address[] memory) {
        return deployedMegaPokers;
    }
}
